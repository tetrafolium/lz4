...
static void test_compress(FILE *outFp, FILE *inpFp, size_t messageMaxBytes,
...
static void test_decompress(FILE *outFp, FILE *inpFp, size_t messageMaxBytes,
                            size_t ringBufferBytes) {
